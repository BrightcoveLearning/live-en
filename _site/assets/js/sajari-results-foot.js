  ...
  var searchInterface = sajari.init({
      ...
      tabFilters: {defaultTab:"This Site",tabs:[{title:"This Site",filter:"domain='live.support.brightcove.com'"}, {title:"All Brightcove Documentation",filter:""}]}, // User selectable filters
